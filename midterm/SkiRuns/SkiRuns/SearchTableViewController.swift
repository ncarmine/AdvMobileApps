...
class SearchTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(DetailCell.self, forCellReuseIdentifier: "reuseCell")
    }
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        if searchString?.isEmpty == false {
            ...
            let matches = allWords.filter(filter).sorted()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseCell", for: indexPath) as! DetailCell

        // Configure the cell...
        let currWord = filteredWords[indexPath.row]
        cell.textLabel?.text = currWord
        return cell
    }
